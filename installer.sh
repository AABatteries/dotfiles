...
FILES=(.bashrc .vimrc .vim .Slic3r) # list of files/folders to symlink in homedir
...
# Copy any existing dotfiles (not symlinks) in homedir to dotfiles directory and create respective symlinks
for FILE in "${FILES[@]}"; do
